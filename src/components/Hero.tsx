...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-[100svh] w-full py-4 sm:py-6 md:py-8 flex items-center justify-center">
      ...
      <Container className="flex flex-col h-full justify-center w-full">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-4 sm:gap-6 md:gap-10 lg:gap-16">
          <div className="w-full md:w-2/3 animate-fade-in order-2 md:order-1">
            ...
            <div className="flex flex-col gap-2 sm:gap-3">
              ...
              <p className="text-sm sm:text-base md:text-lg text-muted-foreground mb-3 sm:mb-4 md:mb-5 max-w-2xl leading-relaxed">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 mb-4 sm:mb-6">
              <Button size={isMobile ? "default" : "lg"} className="rounded-md" id="contact-button">
                Contact Me
              </Button>
              <div className="flex gap-2">
                ...
                >
                  <Button
                    ...
                    variant="outline"
                    className="rounded-md h-9 sm:h-10 md:h-11 w-9 sm:w-10 md:w-11 flex items-center justify-center"
                  >
          ...
          <div className="w-full sm:w-2/3 md:w-1/3 flex justify-center md:justify-end self-center order-1 md:order-2 mb-4 md:mb-0">
            <div className="relative transform transition-all duration-300 hover:scale-105">
              <div className="w-36 h-36 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-xl">
                <img
              ...
              <div className="absolute -bottom-3 -right-3 bg-primary text-white px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg shadow-md text-xs sm:text-sm font-medium">
